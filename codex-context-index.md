...
Use `codex-file-map.txt` to locate a file, then open the real repository source before editing. Generated context is navigation support and may become stale.
...
- [dashboard](codex-context/apps/dashboard.md)
- [diplome](codex-context/apps/diplome.md)
- [flota](codex-context/apps/flota.md)
- [media_library](codex-context/apps/media_library.md)
- [planificator](codex-context/apps/planificator.md)
- [tasks](codex-context/apps/tasks.md)
...
- `test-results/`: excluded directory
